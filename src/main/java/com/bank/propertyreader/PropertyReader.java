...
public class PropertyReader {
    ...
    public String getProperty(String propertyName){
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir")+"/src/test/java/resources/propertyfile/config.properties");//get this path from properties path 3 rd option do not forget to put / before src
